      ...
      <div className="flex gap-4 justify-center">
        {state?.players.map(p => (
          <div key={p} className="flex flex-col items-center">
            ...
            <span className={`text-lg font-bold ${p === state.chooser ? 'text-primary' : 'text-white'}`}>
        ...
        <div className="w-full flex flex-col gap-3">
          {state.hint && (
            <div className="text-center py-3">
              <span className={`text-2xl font-bold ${state.hint === 'maior' ? 'text-green-400' : state.hint === 'menor' ? 'text-red-400' : 'text-primary'}`}>
